...
ot.EditorClient = (function () {
   ...
   * @param {*} editorAdapter  CodeMirrorAdapter 实例对象
   */
  function EditorClient (revision, clients, serverAdapter, editorAdapter) {
    ...
    this.initializeClientList(); // 初始化用户列表容器元素
    this.initializeClients(clients); // 初始化用户对象OtherClient，会当到this.clients中
